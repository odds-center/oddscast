...
| 영역            | 기능                 | 상태 | 파일 위치                                  |
| --------------- | -------------------- | ---- | ------------------------------------------ |
| **인증**        | Google OAuth 2.0     | ✅   | `server/src/auth/`                         |
| **사용자**      | 사용자 관리          | ✅   | `server/src/users/`                        |
| **경주 정보**   | KRA API 통합         | ✅   | `server/src/kra-api/`                      |
| **경주 데이터** | 경주 계획/결과       | ✅   | `server/src/races/`, `server/src/results/` |
| **베팅 기록**   | 베팅 CRUD            | ✅   | `server/src/bets/`                         |
| **배치 작업**   | 데이터 수집 스케줄러 | ✅   | `server/src/batch/`                        |

### 🔄 구현 필요 (60%)

| 영역        | 기능               | 우선순위  | 예상 시간 |
| ----------- | ------------------ | --------- | --------- |
| **AI 예측** | LLM 통합 (GPT-4o)  | 🔥 **P0** | 2주       |
| **예측권**  | 예측권 관리 시스템 | 🔥 **P0** | 1주       |
| **구독**    | 구독 관리          | 🔥 **P0** | 1주       |
| **결제**    | Toss Payments 통합 | 🔥 **P0** | 1주       |
| **모바일**  | AI 예측 UI         | 🔥 **P0** | 1주       |
| **모바일**  | 구독 UI            | **P1**    | 1주       |
| **통계**    | 예측 정확도 추적   | **P1**    | 3일       |
