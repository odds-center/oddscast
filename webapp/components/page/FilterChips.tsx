...
const chipBase =
  'inline-flex items-center justify-center px-3 py-2.5 sm:px-4 sm:py-2 min-h-[44px] sm:min-h-[38px] rounded-full text-sm font-medium transition-all duration-250 ease touch-manipulation';
