...
interface HorsePickPanelProps {
  ...
  entries: { id?: string; hrNo: string; hrName: string; jkName?: string; weight?: string }[];
  requiredCount: number;
  dividends?: { poolName?: string; chulNo?: string; chulNo2?: string; chulNo3?: string; odds?: number }[];
    ...
    <div className='flex flex-col h-full'>
      ...
      <div className='shrink-0'>
        ...
        <p className='text-text-tertiary text-xs mt-1'>
          {PICK_TYPE_DESCRIPTIONS[pickType]}
        </p>
      </div>
            ...
            return (
              ...
              >
                <div className='flex items-center gap-2 flex-1 min-w-0'>
                  <span className='text-primary font-bold w-7 shrink-0'>{entry.hrNo}</span>
