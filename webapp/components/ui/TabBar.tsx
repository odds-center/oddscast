...
const btnSm = 'flex-1 min-h-[44px] sm:min-h-0 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-200 ease touch-manipulation';
const btnMd = 'flex-1 min-h-[44px] sm:min-h-0 py-3 px-4 rounded-lg text-sm font-semibold transition-all duration-200 ease touch-manipulation';
