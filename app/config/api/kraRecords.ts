// KRA (한국마사회) 경주기록 정보 API 설정
export const KRA_RECORDS_CONFIG = {
  // 기본 API 설정
  baseURL: 'https://apis.data.go.kr/B551015/API4_3',
...
// KRA 경주기록 API 응답 타입 정의
export interface KRARaceRecord {
  meet: string; // 경마장 코드
...
// KRA 경주기록 API 헬퍼 함수들
export const KRA_RECORDS_HELPERS = {
  // API 키 유효성 검사
  validateApiKey: (): boolean => {
    return !!KRA_RECORDS_CONFIG.apiKey;
  },
...
export default KRA_RECORDS_CONFIG;
